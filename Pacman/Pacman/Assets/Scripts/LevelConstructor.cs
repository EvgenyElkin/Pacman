...
public class LevelConstructor : MonoBehaviour
{
    ...
    public void Start ()
    {
		...
		{
			new RouterItem { X= -1.45f, Y= -0.65f, CanUp=true, CanDown=true, CanRight=true, CanLeft=false},
			new RouterItem { X= 1.45f, Y= -0.65f, CanUp=true, CanDown=true, CanRight=false, CanLeft=true},
			new RouterItem { X= -1.45f, Y= 1.3f, CanUp=false, CanDown=true, CanRight=true, CanLeft=false},
			new RouterItem { X= 1.45f, Y= 1.3f, CanUp=false, CanDown=true, CanRight=false, CanLeft=true},
			new RouterItem { X=0.5f, Y= 1.3f, CanUp=true, CanDown=false, CanRight=true, CanLeft=true},
			new RouterItem { X= -0.5f, Y= 1.3f, CanUp=true, CanDown=false, CanRight=true, CanLeft=true},
			new RouterItem { X= -1.45f, Y=0.3f, CanUp=true, CanDown=true, CanRight=false, CanLeft=true},
			new RouterItem { X= 1.45f, Y=0.3f, CanUp=true, CanDown=true, CanRight=true, CanLeft=false},
			new RouterItem { X= -0.5f, Y= 2.25f, CanUp=false, CanDown=true, CanRight=false, CanLeft=true},
			new RouterItem { X=0.5f, Y= 2.25f, CanUp=false, CanDown=true, CanRight=true, CanLeft=false},
			new RouterItem { X= -1.45f, Y= 2.25f, CanUp=true, CanDown=false, CanRight=true, CanLeft=false},
			new RouterItem { X= 1.45f, Y= 2.25f, CanUp=true, CanDown=false, CanRight=false, CanLeft=true},
			new RouterItem { X= -1.45f, Y= 3.25f, CanUp=false, CanDown=true, CanRight=true, CanLeft=true},
			new RouterItem { X= 1.45f, Y= 3.25f, CanUp=false, CanDown=true, CanRight=true, CanLeft=true},
			...
			new RouterItem { X= -2.4f, Y= 2.25f, CanUp=true, CanDown=true, CanRight=false, CanLeft=true},
			new RouterItem { X= 2.4f, Y= 2.25f, CanUp=true, CanDown=true, CanRight=true, CanLeft=false},
			...
			new RouterItem { X= -3.4f, Y= -3.5f, CanUp=true, CanDown=false, CanRight=true, CanLeft=true},
			new RouterItem { X= 3.4f, Y= -3.5f, CanUp=true, CanDown=false, CanRight=true, CanLeft=true},
			...
			new RouterItem { X= 0f, Y= 1.3f, CanUp=false, CanDown=false, CanRight=true, CanLeft=true},
			new RouterItem { X= -0.65f, Y= 0.1f, CanUp=true, CanDown=false, CanRight=true, CanLeft=false},
			new RouterItem { X= 0.65f, Y= 0.1f, CanUp=true, CanDown=false, CanRight=false, CanLeft=true},
			new RouterItem { X= -0.65f, Y= 0.5f, CanUp=false, CanDown=true, CanRight=true, CanLeft=false},
			new RouterItem { X= 0.65f, Y= 0.5f, CanUp=false, CanDown=true, CanRight=false, CanLeft=true},
			new RouterItem { X= 0f, Y= 0.5f, CanUp=true, CanDown=false, CanRight=false, CanLeft=false},
		};
}
